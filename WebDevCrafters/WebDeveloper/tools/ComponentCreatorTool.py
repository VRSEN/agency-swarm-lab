...
class ComponentCreatorTool(BaseTool):
    ...
    name: str = Field(
        ...,
        description="The name of the main React component. Examples: App, Button, Header, Footer",
    )
    file_path: str = Field(
        ...,
        description="The path to the file to save the React component code. Example: /Users/johndoe/projects/my-app/components/Button.tsx",
    )
    imports: List[str] = Field(
        ...,
        description="List of imports for the React component. Examples: 'import React from 'react';', 'import PropTypes from 'prop-types';'",
    )
    logic: str = Field(
        ...,
        description="The logic of the component. For example, submitting a form or handling a click event. Leave empty string if no logic is needed. Example: const handleClick = () => console.log('Hello, world!');\n\nconst handleSubmit = (event) => {\n  event.preventDefault();\n  console.log('Form submitted');\n}",
    )
    return_component: Union[ReactComponent, str] = Field(
        ...,
        description="""The return value of the component. For example, a button or a form.
    ...
    def run(self):
        ...
        components_code = (
            self.return_component.render(indent=8)
            if isinstance(self.return_component, ReactComponent)
            else self.return_component
        )
...
"""
        ...
        self._shared_state.set(
            "files_read",
            self._shared_state.get("files_read", [])
